...
//// 2.) Render component in JSX ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    return(
        <>  <div id ="stats" className="w-[95%] border-2 border-black rounded p-5 shadow-md">
                ...
                <p className='text-base'>Assets: {incApi.length > 0 ? incApi[0].currency : ''} {company && assetsData.length > 0 ? formatNumber(assetsData[assetsData.length - 1]) : ''}</p>
                <p className='text-base'>Liabilities: {incApi.length > 0 ? incApi[0].currency : ''} {company && liabilitiesData.length > 0 ? formatNumber(liabilitiesData[liabilitiesData.length - 1]) : ''}</p>
                <p className='text-base'>Stockholders Equity: {incApi.length > 0 ? incApi[0].currency : ''} {company && stockholdersData.length > 0 ? formatNumber(stockholdersData[stockholdersData.length - 1]) : ''}</p>
                <p className='text-base'>Last reported cash balance: {incApi.length > 0 ? incApi[0].currency : ''} {company && cashData.length > 0 ? formatNumber(cashData[cashData.length - 1]) : ''}</p>
            </div>
